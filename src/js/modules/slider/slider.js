export default class Slider {
  ...
  bindTriggers() {
    ...
    const swipe = (el, settings = {}) => {
      ...
      if (swipeSettings.maxTime < settings.minTime)
        swipeSettings.maxTime = swipeSettings.minTime + 500;
  ...
  countSlidesOnPage() {
    return Math.floor(
      this.container.clientWidth / this.container.firstChild.clientWidth
    );
  }
  init() {
    this.bindTriggers();
