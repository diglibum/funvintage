...
/***/ "./src/js/modules/forms/formSelect.js":
/*!********************************************!*\
  !*** ./src/js/modules/forms/formSelect.js ***!
  \********************************************/
...
var FormSelect = /*#__PURE__*/function () {
  ...
  _createClass(FormSelect, [{
    ...
    value: function buildCustomSelect() {
      ...
      this.header = document.createElement("div"); // new select

      this.newSelect = document.createElement("ul");
      this.newSelect.classList.add("dropdown__container");
      this.newSelect.classList.add("dropdown__hidden"); // new options

      this.options.forEach(function (option, ind) {
        ...
        if (!disabled) {
          ...
          newOption.addEventListener("click", function () {
            _this.changeSelectedOption(ind);
        ...
        _this.newSelect.appendChild(newOption); // new header


        if (selected) {
          _this.header.innerText = text;

          _this.header.classList.add("dropdown__header");

          _this.select.parentNode.insertBefore(_this.header, _this.select);
        }
      });
    ...
    key: "bindTriggers",
    value: function bindTriggers(trigger) {
      var _this2 = this;
      ...
      document.querySelector(".overlay").addEventListener("click", function (e) {
        ...
        } else if (_this2.isExpand && target !== _this2.newSelect) {
          _this2.rollup();
        }
      });
    }
    ...
    value: function expand() {
      var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.newSelect;
      this.isExpand = true;
    ...
    value: function changeSelectedOption(ind) {
      var _this3 = this;
      ...
      this.options.forEach(function (option, i) {
        if (i === ind) {
          ...
          _this3.newSelect.childNodes[i].classList.add("dropdown__item_selected");

          _this3.header.innerText = option.innerText;
        } else {
          option.removeAttribute("selected");

          _this3.newSelect.childNodes[i].classList.remove("dropdown__item_selected");
        }
      });
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _formSelect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formSelect */ "./src/js/modules/forms/formSelect.js");
...
var Forms = /*#__PURE__*/function () {
  ...
  _createClass(Forms, [{
    ...
    value: function init() {
      this.hideSelects();
      this.selects.forEach(function (select) {
        new _formSelect__WEBPACK_IMPORTED_MODULE_2__["default"](select).init();
      });
    }
  }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ Modals; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
var Modals = /*#__PURE__*/function () {
  function Modals(modalSelector, trigger) {
...
var Reviews = /*#__PURE__*/function () {
  function Reviews(id) {
    ...
    this.id = id;
    this.trigger = document.querySelector("".concat(this.id, " .reviews__more-btn"));
    this.items = document.querySelectorAll("".concat(this.id, " .reviews-item"));
  ...
  _createClass(Reviews, [{
    ...
    value: function showRows() {
      ...
      var startIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.curRow * this.itemsInRow;
      var increase = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      if (increase) {
        this.curRow += 1;
      }

      var endIndex = this.curRow * this.itemsInRow;

      var _loop = function _loop(i) {
        if (_this2.items[i]) {
          _this2.items[i].classList.remove("hidden");

          setTimeout(function () {
            _this2.items[i].classList.remove("reviews-item_rolled");
          }, 4);

          _this2.showTriggerBtn();
        } else {
          _this2.hideTriggerBtn();
        }
      };
    ...
    key: "countItemsInRows",
    value: function countItemsInRows() {
      var rowWidth = document.querySelector("".concat(this.id, " .reviews-list")).clientWidth;
      this.itemsInRow = Math.floor(rowWidth / this.itemWidth);
    }
  }, {
    key: "hideTriggerBtn",
    value: function hideTriggerBtn() {
      this.trigger.style.display = "none";
    }
  }, {
    key: "showTriggerBtn",
    value: function showTriggerBtn() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ Roller; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
var Roller = /*#__PURE__*/function () {
  function Roller(id) {
    _classCallCheck(this, Roller);

    this.id = id;
    this.items = document.querySelectorAll("".concat(id, " .roller-item"));
  }
  ...
  _createClass(Roller, [{
    ...
    value: function init() {
      this.items.forEach(function (item) {
        item.querySelector(".roller-item__header").addEventListener("click", function () {
...
var Slider = /*#__PURE__*/function () {
  function Slider() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        container = _ref$container === void 0 ? ".slider" : _ref$container,
        _ref$nextBtn = _ref.nextBtn,
        nextBtn = _ref$nextBtn === void 0 ? ".slider__controls-next" : _ref$nextBtn,
        _ref$prevBtn = _ref.prevBtn,
        prevBtn = _ref$prevBtn === void 0 ? ".slider__controls-prev" : _ref$prevBtn,
        _ref$slideBy = _ref.slideBy,
        slideBy = _ref$slideBy === void 0 ? "page" : _ref$slideBy;

    _classCallCheck(this, Slider);

    this.container = document.querySelector("".concat(container, " .slider__content"));
  ...
  _createClass(Slider, [{
    ...
    value: function bindTriggers() {
      ...
      var swipe = function swipe(el) {
        ...
        var swipeSettings = Object.assign({}, {
          minDist: 60,
    ...
    key: "countSlidesOnPage",
    value: function countSlidesOnPage() {
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_roller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/roller */ "./src/js/modules/roller.js");
/* harmony import */ var _modules_reviews__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/reviews */ "./src/js/modules/reviews.js");
...
/* harmony import */ var _modules_modals_modals__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/modals */ "./src/js/modules/modals/modals.js");
/* harmony import */ var _modules_forms_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/forms/forms */ "./src/js/modules/forms/forms.js");
...
window.addEventListener("DOMContentLoaded", function () {
  var roller = new _modules_roller__WEBPACK_IMPORTED_MODULE_0__["default"]("#questions");
  roller.init();
  var reviews = new _modules_reviews__WEBPACK_IMPORTED_MODULE_1__["default"]("#reviews");
  reviews.init();
  var slider = new _modules_slider_slider__WEBPACK_IMPORTED_MODULE_2__["default"]({
    container: ".artists__slider"
  });
  slider.init();
  var orderModal = new _modules_modals_modals__WEBPACK_IMPORTED_MODULE_3__["default"]("#order", ".header__contacts-cart");
  orderModal.init();
  var feedbackModal = new _modules_modals_modals__WEBPACK_IMPORTED_MODULE_3__["default"]("#feedback", "[data-modal='feedback']");
  feedbackModal.init();
  var forms = new _modules_forms_forms__WEBPACK_IMPORTED_MODULE_4__["default"]();
  forms.init();
});
}();
/******/ })()
